...
public partial class user_Tiffin_with_sweet : System.Web.UI.Page
{
        ...
        if (DropDownList1.SelectedIndex != 0)
        {
            if (DropDownList2.SelectedIndex != 0)
            {
                ...
                if (ds11.Tables[0].Rows[0][0].ToString() == "1")
                {
                    ...
                    string z = "select * from tiffin_with_sweet where p_city='" + DropDownList1.Text + "' and standard=1";
                ...
                if (ds11.Tables[0].Rows[0][1].ToString() == "1")
                {
                    ...
                    string x = "select * from tiffin_with_sweet where p_city='" + DropDownList1.Text + "' and average=1";
                ...
                if (ds11.Tables[0].Rows[0][2].ToString() == "1")
                {
                    ...
                    string y = "select * from tiffin_with_sweet where p_city='" + DropDownList1.Text + "' and poor=1";
                ...
                if (ds2.Tables[0].Rows.Count != 0)
                {
                    ...
                    dt = dt.DefaultView.ToTable(true, "t_id", "p_city", "p_id", "p_name", "sabji", "roti", "dal", "chawal", "sweet", "other", "price", "standard", "average", "poor", "tagline", "recommend", "tws_image", "available");

                    Label1.Text = "List Of Tiffin With Sweet";
                    Repeater1.DataSource = dt;
                    Repeater1.DataBind();
                }
                else
                {
                    Label1.Text = "NO Tiffin With Sweet For This City";
    ...
    //    string p = "select * from tiffin_with_sweet where p_city='" + DropDownList1.Text + "'";
    //    ds9 = dc.getdata(p);
    ...
    protected void jk(object sender, CommandEventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert('This Tiffin With Sweet Not Available For Today');", true);
            //Response.Write("<script>alert('This Tiffin With Sweet Not Available For Today')</script>");
        }
