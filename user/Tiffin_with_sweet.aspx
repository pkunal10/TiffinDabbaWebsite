<%@ Page Title="" Language="C#" MasterPageFile="~/user/user_without_slider.master" AutoEventWireup="true" CodeFile="Tiffin_with_sweet.aspx.cs" Inherits="user_Tiffin_with_sweet" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

    <title>Tiffin Dabba | Tiffin With Sweet</title>
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li>
							...
							<div class="intro">
								<h1>TIFFIN DABBA</h1>
								<p><span>Tiffin With Sweet List</span></p>
							</div>
						</li>
					</ul>
				</div>			
                                            ...
                                            <ItemTemplate>
                                                <li class="span3">
								                    <div class="product-box">
									                    ...
									                    <font><strong>Roti:- <%#Eval("roti") %> (5 Pc.)</strong></font><br />
                                                        ...
                                                        <asp:LinkButton ID="linkb1" runat="server" OnCommand ="jk" CssClass="btn_own_order" Height="20px" Width="90px" CommandName='<%#Eval("available") + ";" + Eval("t_id") %>'><%#Eval("available")%> </asp:LinkButton>
                                                        <%--<asp:LinkButton ID="linkb1" runat="server" OnCommand ="jk" Enabled="false" CssClass="btn_own_order" Height="20px" Width="90px" CommandName='<%#Eval("available") + ";" + Eval("t_id") %>'>Diwali Vacation</asp:LinkButton>--%>
								                    </div>
							                    </li>
                                            </ItemTemplate>
                                        </asp:Repeater>       
