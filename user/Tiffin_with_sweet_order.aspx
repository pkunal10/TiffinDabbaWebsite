<%@ Page Title="" Language="C#" MasterPageFile="~/user/user_without_slider.master" AutoEventWireup="true" CodeFile="Tiffin_with_sweet_order.aspx.cs" Inherits="user_Tiffin_with_sweet_order" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

    <title>Tiffin Dabba | Tiffin With Sweet Order Details</title>
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li>
							...
							<div class="intro">
								<h1>TIFFIN DABBA</h1>
								<p><span>Tiffin With Sweet Order Details</span></p>
							</div>
						</li>
					</ul>
				</div>			
					...
					<div class="span9">
						<div class="row">
							...
							<div class="span5">
                                ...
                                <strong>Sweet:</strong> <span><asp:Label ID="Label11" runat="server" Text=""></asp:Label></span><br>
                                ...
                                <asp:Label ID="Label12" runat="server" CssClass="label-warning" Text=""></asp:Label><br />
