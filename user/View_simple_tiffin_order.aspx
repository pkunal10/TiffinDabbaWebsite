<%@ Page Title="" Language="C#" MasterPageFile="~/user/user_without_slider.master" AutoEventWireup="true" CodeFile="View_simple_tiffin_order.aspx.cs" Inherits="user_View_simple_tiffin_order" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

    <title>Tiffin Dabba | View Simple Tiffin Order</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					<ul class="slides">
						...
						<li>
							...
							<div class="intro">
								<h1>TIFFIN DABBA</h1>
								<p><span>Order Details Of Simple Tiffin</span></p>
							</div>
						</li>
					</ul>
				</div>			
            ...
            <section class="header_text">
				 Below are your today's order details of Simple Tiffin....
