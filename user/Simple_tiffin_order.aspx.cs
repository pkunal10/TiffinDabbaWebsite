...
public partial class user_Simple_tiffin_order : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (IsPostBack != true)
            {
                ...
                string k = "select sabji,roti,dal,chawal,price,other,st_image from simple_tiffin where t_id='" + Session["stid"].ToString() + "'";
                ds2 = dc.getdata(k);

                Tiffin_Image.ImageUrl = ds2.Tables[0].Rows[0][6].ToString();
                ...
                Label9.Text = ds2.Tables[0].Rows[0][4].ToString();
                Other_lbl.Text = ds2.Tables[0].Rows[0][5].ToString();
            }
        }
    }
    ...
    private void sendmail_provider_dinner()
    {
        try
        {
            ...
            string p_id = "select p_id from simple_tiffin where t_id='" + Session["stid"].ToString() + "'";
    ...
    private void sendmail_user_dinner()
    {
        try
        {
            ...
            mm.Body = "<br />Hello:  " + Label2.Text + "<br /><center><font style='font-size:13px;weight:550;'>You Book Simple Tiffin For DINNER From TIFFIN DABBA.</font><br /><br /><table border='1' height='50%' width='65%'><caption>Order Details</caption><tr><td>Order Id:</td><td>" + Label1.Text + "</td></tr><tr><td>Order Date:</td><td>" + Label3.Text + "</td></tr><tr><td>Order Time:</td><td>" + Label4.Text + "</td></tr>" +
                    ...
                    "<tr><td>Roti:</td><td>" + Label6.Text + "</td></tr><tr><td>Dal/Kadi:</td><td>" + Label7.Text + "</td></tr><tr><td>Chawal/Khichdi:</td><td>" + Label8.Text + "</td></tr><tr><td>Other:</td><td>" + Other_lbl.Text + "</td></tr><tr><td colspan='2' align='center'><b>Total Bill:  " + Label9.Text + " Rs.</b>(Inclusive Of All Charges)</td></tr></table>" +
    ...
    private void sendmail_user_lunch()
    {
        try
        {
            ...
            mm.Body = "<br />Hello:  " + Label2.Text + "<br /><center><font style='font-size:13px;weight:550;'>You Book Simple Tiffin For LUNCH From TIFFIN DABBA.</font><br /><br /><table border='1' height='50%' width='65%'><caption>Order Details</caption><tr><td>Order Id:</td><td>" + Label1.Text + "</td></tr><tr><td>Order Date:</td><td>" + Label3.Text + "</td></tr><tr><td>Order Time:</td><td>" + Label4.Text + "</td></tr>" +
                    "</table><br /><table border='1' height='100%' width='100%'><caption>Delivery Address</caption><tr><td>Address:  </td><td>" + TextBox2.Text + "</td></tr></table>" +
                    "<br /><font style='font-size:12px;weight:450;'>Your Tiffin's Menu Is Given Below:</font><table border='1' height='50%' width='60%'><tr><td>Sabji:</td><td>" + Label5.Text + "</td></tr>" +
                    "<tr><td>Roti:</td><td>" + Label6.Text + "</td></tr><tr><td>Dal/Kadi:</td><td>" + Label7.Text + "</td></tr><tr><td>Chawal/Khichdi:</td><td>" + Label8.Text + "</td></tr><tr><td>Other:</td><td>" + Other_lbl.Text + "</td></tr><tr><td colspan='2' align='center'><b>Total Bill:  " + Label9.Text + " Rs.</b>(Inclusive Of All Charges)</td></tr></table>" +
    ...
    private void sendmail_admin_lunch()
    {
        try
        {
            ...
            mm.Body = "<br />Hello:  Amin<br /><center><font style='font-size:13px;weight:550;'>Someone Book Simple Tiffin For LUNCH From TIFFIN DABBA.</font><br /><br /><table border='1' height='50%' width='65%'><caption>Order Details</caption><tr><td>Order Id:</td><td>" + Label1.Text + "</td></tr><tr><td>Order Date:</td><td>" + Label3.Text + "</td></tr><tr><td>Order Time:</td><td>" + Label4.Text + "</td></tr>" +
                    "</table><br /><table border='1' height='100%' width='100%'><caption>Delivery Address</caption><tr><td>Address:  </td><td>" + TextBox2.Text + "</td></tr></table>" +
                    "<br /><font style='font-size:12px;weight:450;'>Your Tiffin's Menu Is Given Below:</font><table border='1' height='50%' width='60%'><tr><td>Sabji:</td><td>" + Label5.Text + "</td></tr>" +
                    "<tr><td>Roti:</td><td>" + Label6.Text + "</td></tr><tr><td>Dal/Kadi:</td><td>" + Label7.Text + "</td></tr><tr><td>Chawal/Khichdi:</td><td>" + Label8.Text + "</td></tr><tr><td>Other:</td><td>" + Other_lbl.Text + "</td></tr><tr><td colspan='2' align='center'><b>Total Bill:  " + Label9.Text + " Rs.</b>(Inclusive Of All Charges)</td></tr></table>" +
                    "<br /><font style='font-size:12px;'>You Will Receive Your Tiffin At Your Delivery Address Between 12:00 PM to 01:30 PM.</font></center>";
