<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="View_simple_tiffin_order.aspx.cs" Inherits="admin_View_simple_tiffin_order" %>
...
<br />
    <div>
        <center>
       <h2><font style="color:Black;">Order Details Of Simple Tiffin</font></h2> 
...
<SortedDescendingHeaderStyle BackColor="#820000"></SortedDescendingHeaderStyle>
                    ...
                    <asp:WizardStep ID="WizardStep1" runat="server" Title="By Date">
                    <center>
                        <table style="width:620px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Text="Enter Date" ControlToValidate="TextBox3" ValidationGroup="ostdate"></asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
                                <td>
                                    Order Of</td>
