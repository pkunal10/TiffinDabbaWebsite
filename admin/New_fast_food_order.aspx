<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="New_fast_food_order.aspx.cs" Inherits="admin_New_fast_food_order" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>New Fast Food Orders</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <center>
        <h2>New Fast Food Order Of Today</h2>
