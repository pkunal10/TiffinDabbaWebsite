...
public partial class Full_details_of_tiffin_with_swwet_order : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (IsPostBack != true)
        {
            ...
            else
            {
                ...
                string j = "select * from tiffin_with_sweet_daily_order where order_id=" + Session["tws_order_id"];
                ds = dc.getdata(j);

                Label4.Text = "Full Tiffin With Sweet Order Details Of :- " + ds.Tables[0].Rows[0][0].ToString();
                ...
                Label5.Text = ds.Tables[0].Rows[0][16].ToString();
                Other_lbl.Text = ds.Tables[0].Rows[0][17].ToString();
                Label16.Text = ds.Tables[0].Rows[0][18].ToString();
                Image1.ImageUrl = ds.Tables[0].Rows[0][19].ToString();
                Label17.Text = ds.Tables[0].Rows[0][20].ToString();
            }
        }
    }
    ...
    private void send_depart_email()
    {
        try
        {
            ...
            mm.Body = "Hello:  " + Label6.Text + "<br /><br /> Your order for " + Label2.Text + " of Tiffin With Sweet is Departure from here. you will get your Tiffin With Sweet " +
                "with in one hour.<br /><br /> Your menu is given below:<br />" + "Order Id:  " + Label1.Text + "<br />Sabji:  " + Label12.Text +
                          "<br />Roti:  " + Label13.Text + "<br />Dal:  " + Label14.Text + "<br />Chawal:  " + Label15.Text + "<br />Sweet:   " + Label5.Text + "<br />Price:  " + Label16.Text;
        ...
        {
            Label19.Text = "Email Sending is failed due to server error please try again";
        }
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        string s = "update tiffin_with_sweet_daily_order set status='Delivered' where order_id=" + Label1.Text;
        dc.setdata(s);

        DataSet ds10 = new DataSet();
        string j = "select * from tiffin_with_sweet_daily_order where order_id=" + Label1.Text;
        ds10 = dc.getdata(j);
        Label17.Text = ds10.Tables[0].Rows[0][19].ToString();
    ...
    private void block_user()
    {
        ...
        string pj = "insert into cancelled_tiffin_with_sweet_daily_order values('" + Label1.Text + "','" + Label2.Text + "','" + Label3.Text + "','" + LinkButton1.Text + "','" + LinkButton2.Text + "','" + Label6.Text + "','" + Label7.Text + "','" + Label8.Text + "','" + Label9.Text + "','" + Label10.Text + "','" + Label5.Text + "','" + Label11.Text + "','" + Label12.Text + "','" + Label13.Text + "','" + Label14.Text + "','" + Label15.Text + "','" + Label5.Text + "','" + Label16.Text + "','" + ds10.Tables[0].Rows[0][18].ToString() + "')";
        dc.setdata(pj);

        string jp = "delete from tiffin_with_sweet_daily_order where order_id=" + Label1.Text;
        dc.setdata(jp);
    ...
    {
        string r = "update tiffin_with_sweet_daily_order set status='Cancelled' where order_id=" + Label1.Text;
        dc.setdata(r);
        ...
        string jk = "insert into cancelled_tiffin_with_sweet_daily_order values('" + Label1.Text + "','" + Label2.Text + "','" + Label3.Text + "','" + LinkButton1.Text + "','" + LinkButton2.Text + "','" + Label6.Text + "','" + Label7.Text + "','" + Label8.Text + "','" + Label9.Text + "','" + Label10.Text + "','" + Label5.Text + "','" + Label11.Text + "','" + Label12.Text + "','" + Label13.Text + "','" + Label14.Text + "','" + Label15.Text + "','" + Label5.Text + "','" + Label16.Text + "','" + ds10.Tables[0].Rows[0][18].ToString() + "')";
        dc.setdata(jk);
