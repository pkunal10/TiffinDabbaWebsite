...
public partial class admin_Today_delivered_ff_order : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string zk = "select DISTINCT order_id,date,time,del_city,del_area from fast_food_orders where date='" + current_time.ToLongDateString() + "' and delivered = 1";
            ...
            else
            {
                ...
                new_ff_order_gv.DataBind();
                no_order_lbl.Text = "No Delivered Orders Of Today";
            }
        }
    }
