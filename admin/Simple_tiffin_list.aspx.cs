...
public partial class admin_Simple_tiffin_list : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (DropDownList1.SelectedIndex != 0)
        {
            ...
            string j = "select * from simple_tiffin where p_city='" + DropDownList1.Text + "'";
            ds1 = dc.getdata(j);

            if (ds1.Tables[0].Rows.Count != 0)
            {
                Label1.Text = "Simple Tiffin Available In " + DropDownList1.Text + " City";
            ...
            else
            {
                ...
                GridView1.DataBind();
                Label1.Text = "No Simple Tiffin Available In " + DropDownList1.Text + " City";
            }
        }
        else
        {
    ...
    protected void jk(object sender, CommandEventArgs e)
    {
        ...
        Session["stid"] = j;
        Response.Redirect("~/admin/Simple_tiffin_menu.aspx");
    }
    ...
    protected void UpdateTiffin(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string zk = "update simple_tiffin set standard='" + stdu + "',average='" + avgu + "',poor='" + pooru + "',tagline='" + taglineu + "',recommend='" + recommendu + "',IsAppHome=" + isAppHomeChk.Checked + " where t_id='" + t_id + "'";
        dc.setdata(zk);
        GridView1.EditIndex = -1;
        BindData();
    ...
    {
        string z = "select * from simple_tiffin";
