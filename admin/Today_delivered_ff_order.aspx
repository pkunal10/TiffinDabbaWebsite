<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="Today_delivered_ff_order.aspx.cs" Inherits="admin_Today_delivered_ff_order" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Today Delivered Fast Food Orders</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <center>
        <h2>Delivered Fast Food Order Of Today</h2>
