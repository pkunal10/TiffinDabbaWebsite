...
public partial class admin_View_trial_tiffin_order : System.Web.UI.Page
{
    ...
    {
        DataSet ds = new DataSet();
        string s = "select * from trial_tiffin_order where order_id=" + Convert.ToString(TextBox1.Text);
        ds = dc.getdata(s);
    ...
    protected void full_details_of_order(object sender, CommandEventArgs e)
    {
        ...
        Session["tt_order_id"] = y;
        Response.Redirect("~/admin/Full_details_of_trial_tiffin_order.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        if (DropDownList1.SelectedIndex != 0)
        {
            ...
            string j = "select * from trial_tiffin_order where pid='" + TextBox2.Text + "' and book_for='" + DropDownList1.Text + "'";
            ds1 = dc.getdata(j);
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        if (DropDownList2.SelectedIndex != 0)
        {
            ...
            string k = "select * from trial_tiffin_order where date='" + TextBox3.Text + "' and book_for='" + DropDownList2.Text + "'";
            ds2 = dc.getdata(k);
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        if (DropDownList3.SelectedIndex != 0)
        {
            ...
            string l = "select * from trial_tiffin_order where date='" + DateTime.Now.ToLongDateString() + "' and book_for='" + DropDownList3.Text + "'";
            ds3 = dc.getdata(l);

            if (ds3.Tables[0].Rows.Count != 0)
            {
                Label4.Text = "Today's Order Details For " + DropDownList3.Text + " Of Trial Tiffin";
            ...
            {
                Label4.Text = "No Orders Of Trial Tiffin For " + DropDownList3.Text + " Today";
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        if (DropDownList4.SelectedIndex != 0)
        {
            ...
            string m = "select * from trial_tiffin_order where book_for='" + DropDownList4.Text + "'";
            ds4 = dc.getdata(m);

            if (ds4.Tables[0].Rows.Count != 0)
            {
                Label5.Text = "All Orders Of Trial Tiffin For " + DropDownList4.Text;
                GridView5.DataSource = ds4;
                GridView5.DataBind();
            }
            else
            {
                Label5.Text = "No Order Of Trial Tiffin For " + DropDownList4.Text + " Yet";
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string j = "select * from trial_tiffin_order where date='" + DateTime.Now.ToLongDateString() + "' and book_for='" + DropDownList5.Text + "' and delivery_area='" + DropDownList7.Text + "'";
                    ds10 = dc.getdata(j);
                    if (ds10.Tables[0].Rows.Count != 0)
                    {
                        Label6.Text = "Today's Orders Of Trial Tiffin For " + DropDownList5.SelectedItem + " In:-  " + DropDownList7.SelectedItem;
                        GridView6.DataSource = ds10;
                        GridView6.DataBind();
                    }
                    else
                    {
                        Label6.Text = "No Orders Of Trial Tiffin In:-  " + DropDownList7.SelectedItem + "  For " + DropDownList5.Text + " Today";
                        GridView6.DataSource = "";
                        GridView6.DataBind();
                    }
                }
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    DataSet ds10 = new DataSet();
                    string j = "select * from trial_tiffin_order where delivery_area='" + DropDownList10.Text + "'";
                    ds10 = dc.getdata(j);
                    if (ds10.Tables[0].Rows.Count != 0)
                    {
                        Label7.Text = "All Orders Of Trial Tiffin For " + DropDownList8.SelectedItem + " In:-  " + DropDownList10.SelectedItem;
                        GridView7.DataSource = ds10;
                        GridView7.DataBind();
                    }
                    else
                    {
                        Label7.Text = "No Orders Of Trial Tiffin In:-  " + DropDownList10.SelectedItem + "  For " + DropDownList8.Text + " Yet";
                        GridView7.DataSource = "";
                        GridView7.DataBind();
                    }
                }
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                sb.Append("</td>");
                sb.Append("<td colspan='2'>");
                sb.Append("Tiffin Type:- Trial Tiffin");
                sb.Append("</td>");
                sb.Append("</tr>");
                sb.Append("<tr>");
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Trial Tiffin Order Sheet Of " + DropDownList3.Text + " On " + DateTime.Now.ToLongDateString() + ".pdf");
