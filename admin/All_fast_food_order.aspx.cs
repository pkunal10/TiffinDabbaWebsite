...
public partial class admin_All_fast_food_order : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string zk = "select DISTINCT order_id,date,time,del_city,del_area from fast_food_orders";
            ...
            else
            {
                ...
                new_ff_order_gv.DataBind();
                no_order_lbl.Text = "No Orders Of Fast Food Yet";
            }
        }
    }
