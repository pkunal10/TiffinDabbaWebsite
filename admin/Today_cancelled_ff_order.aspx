<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="Today_cancelled_ff_order.aspx.cs" Inherits="admin_Today_cancelled_ff_order" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Today Cancelled Fast Food Orders</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <center>
        <h2>Cancelled Fast Food Order Of Today</h2>
