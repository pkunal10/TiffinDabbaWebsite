<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="Simple_tiffin_menu.aspx.cs" Inherits="admin_Simple_tiffin_menu" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

    <title>Simple Tiffin Menu</title>
            ...
            <table style="width:400px;">
                ...
                <tr>
                    ...
                    <td>
                     ...
                     Text="Enter Sabji" ValidationGroup="astm" ControlToValidate="TextBox1"></asp:RequiredFieldValidator><br />
                ...
                <tr>
                    ...
                    <td>
                     ...
                     Text="Enter Roti" ValidationGroup="astm" ControlToValidate="TextBox2"></asp:RequiredFieldValidator><br />
                ...
                <tr>
                    ...
                    <td>
                     ...
                     Text="Enter Dal" ValidationGroup="astm" ControlToValidate="TextBox3"></asp:RequiredFieldValidator><br />
                ...
                <tr>
                    ...
                    <td>
                     ...
                     Text="Enter Chawal" ValidationGroup="astm" ControlToValidate="TextBox4"></asp:RequiredFieldValidator><br />
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Enter Other"
                     Text="Enter Other" ValidationGroup="astm" ControlToValidate="TextBox6"></asp:RequiredFieldValidator><br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="Alphabates Only"
                     Text="Alphabates Only" ValidationExpression="[a-zA-Z ]*$" ValidationGroup="astm" 
                            ControlToValidate="TextBox6"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>
                    <td>
                        Price</td>
                    ...
                    <td>
                     ...
                     Text="Enter Price" ValidationGroup="astm" ControlToValidate="TextBox5"></asp:RequiredFieldValidator><br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="Numbers Only"
                     Text="Numbers Only" ValidationExpression="[0-9]*" ValidationGroup="astm" ControlToValidate="TextBox5"></asp:RegularExpressionValidator></td>
                </tr>

                <tr>
                    <td colspan="3">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button1" runat="server" Text="Update" onclick="Button1_Click" ValidationGroup="astm"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
