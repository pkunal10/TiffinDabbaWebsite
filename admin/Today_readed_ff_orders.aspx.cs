...
public partial class admin_Today_readed_ff_orders : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string zk = "select DISTINCT order_id,date,time,del_city,del_area from fast_food_orders where date='" + current_time.ToLongDateString() + "' and read_order = 1";
            ...
            else
            {
                ...
                new_ff_order_gv.DataBind();
                no_order_lbl.Text = "No Readed Orders Of Today";
            }
        }
    }
