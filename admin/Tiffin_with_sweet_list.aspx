<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="Tiffin_with_sweet_list.aspx.cs" Inherits="admin_Tiffin_with_sweet_list" %>
                ...
                <AlternatingRowStyle BackColor="White" />
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText ="Tiffin Image"  >
                            <ItemTemplate>
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("tws_image") %>' Height="120px" Width="120px" />
                            </ItemTemplate>
                        </asp:TemplateField>
