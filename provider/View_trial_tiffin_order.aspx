<%@ Page Title="" Language="C#" MasterPageFile="~/provider/provider_highted_master.master" AutoEventWireup="true" CodeFile="View_trial_tiffin_order.aspx.cs" Inherits="provider_View_trial_tiffin_order" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
       ...
       <div style="height:150px;">
        ...
        <div style="height:60px;width:1000px;border-bottom-style:dashed;border-bottom-width:1.5px;"><br />
                <font class="pagetitle">Order Details Of Trial Tiffin</font>
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            From this page you can see order details of Trial tiffin.you can check order of simple tiffin by different ways.
