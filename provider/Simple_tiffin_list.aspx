<%@ Page Title="" Language="C#" MasterPageFile="~/provider/provider.master" AutoEventWireup="true" CodeFile="Simple_tiffin_list.aspx.cs" Inherits="provider_Simple_tiffin_list" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      <div style="height:150px;">
        ...
        <div style="height:60px;width:1000px;border-bottom-style:dashed;border-bottom-width:1.5px;"><br />
                <font class="pagetitle">Simple Tiffin List</font>
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            From this page you can see list of SIMPLE TIFFIN you provide to our user.and you can update price and availability of perticular tiffin by clicking on tiffin id.
            ...
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                    ...
                    <AlternatingRowStyle BackColor="White" />
                        ...
                        <asp:TemplateField HeaderText ="Tiffin Id">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="jk" CssClass="likbtn" CommandName='<%#Eval("t_id")%>'><%#Eval("t_id") %></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
