<%@ Page Title="" Language="C#" MasterPageFile="~/provider/provider_highted_master.master" AutoEventWireup="true" CodeFile="View_tiffin_with_sweet_order.aspx.cs" Inherits="provider_View_tiffin_with_sweet_order" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
       ...
       <div style="height:150px;">
        ...
        <div style="height:60px;width:1000px;border-bottom-style:dashed;border-bottom-width:1.5px;"><br />
                <font class="pagetitle">Order Details Of Tiffin With Sweet</font>
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            From this page you can see order details of tiffin with sweet.you can check order of tiffin with sweet by different ways.
        ...
        <center>
           ...
           <br />
            ...
            <asp:Wizard ID="Wizard1" runat="server" BackColor="#FFFBD6" 
                ...
                Height="780px" Width="1000px" ActiveStepIndex="3">
                ...
                <SideBarStyle BackColor="#757575" Font-Size="1.0em" VerticalAlign="Middle" Width="210px" />
                <WizardSteps>

                    <asp:WizardStep ID="WizardStep4" runat="server" Title="Today's Order By Meal">
                    <center>
                        <table class="style3">
                            <tr>
                                <td>
                        ...
                        <asp:GridView ID="GridView4" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" Width="1804px">
                            <AlternatingRowStyle BackColor="White" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Swwet">
                                        <ItemTemplate>
                                            <%#Eval("sweet")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <asp:WizardStep ID="WizardStep1" runat="server" title="Today's Order">
                        <center><asp:Button ID="Button1" runat="server"  Text="Show" OnClick="Button1_Click" /></center>
                        <br />
                        <br />
                        <asp:Label ID="Label1" runat="server" CssClass="war"></asp:Label>
                        <br />
                        <br />
                        <div style="width:800px;height:750px;overflow:auto;">
                        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" Width="1803px">
                            <AlternatingRowStyle BackColor="White" />
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" title="Search By Date">
                    <center>
                        <table class="style2">
                            <tr>
                                <td>
                        ...
                        <br />
                        <div style="width:800px;height:750px;overflow:auto;">
                        <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" Width="1798px">
                            <AlternatingRowStyle BackColor="White" />
                    ...
                    <asp:WizardStep ID="WizardStep3" runat="server" Title="All Orders">
                        <center><asp:Button ID="Button3" runat="server" Text="Show" OnClick="Button3_Click" /></center>
                        <br />
                        <br />
                        <asp:Label ID="Label3" runat="server" CssClass="war"></asp:Label>
                        <br />
                        <div style="width:800px;height:750px;overflow:auto;">
                        <asp:GridView ID="GridView3" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" Width="1793px">
                            <AlternatingRowStyle BackColor="White" />
