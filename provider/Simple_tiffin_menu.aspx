<%@ Page Title="" Language="C#" MasterPageFile="~/provider/provider.master" AutoEventWireup="true" CodeFile="Simple_tiffin_menu.aspx.cs" Inherits="provider_Simple_tiffin_menu" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      <div style="height:150px;">
        ...
        <div style="height:60px;width:1000px;border-bottom-style:dashed;border-bottom-width:1.5px;"><br />
                <font class="pagetitle">Simple Tiffin Menu</font>
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            From this page you can see menu of perticular SIMPLE TIFFIN you provide to our user.and you can update 
